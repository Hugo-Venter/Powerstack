    <footer class="footer footer-static footer-light navbar-border">
      <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-block d-md-inline-block">Copyright  &copy; 2018</span></p>
    </footer>
    ...
    <script src="<?php echo base_url('/app-assets/vendors/js/extensions/jquery.knob.min.js'); ?>"></script>
    ...
    <script src="<?php echo base_url('/app-assets/vendors/js/charts/echarts/echarts.js'); ?>"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN ROBUST JS-->
    ...
    <!-- END ROBUST JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="<?php echo base_url('/app-assets/js/scripts/pages/dashboard.min.js'); ?>"></script>
    <!-- END PAGE LEVEL JS-->
	 <script src="<?php echo base_url('/app-assets/vendors/js/forms/icheck/icheck.min.js'); ?>"></script>
 <script src="<?php echo base_url('/app-assets/js/scripts/forms/checkbox-radio.min.js'); ?>"></script>
 <script src="<?php echo base_url('/app-assets/vendors/js/forms/toggle/bootstrap-switch.min.js'); ?>"></script>
	...
	<script src="<?php echo base_url('/app-assets/js/scripts/forms/switch.min.js'); ?>"></script>
  </body>